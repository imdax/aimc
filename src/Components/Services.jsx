    ...
    <section className="w-full bg-[#ededed] py-16 md:py-20 lg:py-24 px-6 md:px-12 lg:px-20">
      <div className="max-w-[1500px] mx-auto grid grid-cols-1 lg:grid-cols-2 items-start gap-12 lg:gap-20">
        ...
        <div className="max-w-[560px]">
          ...
          <button className="px-8 py-3 lg:px-10 lg:py-4 border border-[#c1121f] text-[#c1121f] rounded-full text-[16px] lg:text-[20px] font-semibold hover:bg-[#780000] hover:text-white transition">
            View All Services
          </button>
        </div>
      </div>
